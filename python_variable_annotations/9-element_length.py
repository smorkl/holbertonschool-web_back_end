...
The `element_length` function accepts an iterable of sequences and returns a list
of tuples. Each tuple contains an element from the input iterable and its corresponding length.
"""
